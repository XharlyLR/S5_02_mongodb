...
public class PlayerController {
	...
	public ResponseEntity<Player> addPlayer(@RequestBody Player player){
		try {
			Player _player = playerService.savePlayer(new Player(player.getNomPlayer(), playerService.autoId()));
	...
	public ResponseEntity<Daus> addDaus(@RequestBody Player player){
		try {
			Daus daus = dausService.saveDaus(new Daus(player.getPlayerID(), dausService.autoId()));
